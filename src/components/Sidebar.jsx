...
function Sidebar() {
  ...
  return (
    <aside className="w-20 xl:w-64 h-screen sticky top-0 flex flex-col border-r border-gray-800 p-2">
      {/* Logo */}
      <div className="p-3 mb-4">
        <div className="flex items-center gap-3">
          ...
          <span className="hidden xl:block text-xl font-bold">WikiScroll</span>
        </div>
      </div>
      ...
      {/* Footer info */}
      <div className="hidden xl:block p-3 text-xs text-gray-500">
